...
<head>
    ...
    <!-- DEMO CHARTS -->
    <link rel="stylesheet" href="<?php echo BASE_URL ?>/layout/template/demo/chartist.css">
    <link rel="stylesheet" href="<?php echo BASE_URL ?>/layout/template/demo/chartist-plugin-tooltip.css">
    ...
    <nav class="navbar flex-nowrap p-0">
        <div class="navbar-brand-wrapper d-flex align-items-center col-auto">
            ...
            <a class="navbar-brand navbar-brand-mobile" href="/">
                <img class="img-fluid w-100" src="<?php echo BASE_URL ?>/layout/template/img/logo-mini.png" alt="Graindashboard">
            </a>
            <!-- End Logo For Mobile View -->

            <!-- Logo For Desktop View -->
            <a class="navbar-brand navbar-brand-desktop" href="/">
                <img class="side-nav-show-on-closed" src="<?php echo BASE_URL ?>/layout/template/img/logo-mini.png" alt="Graindashboard" style="width: auto; height: 33px;">
                <img class="side-nav-hide-on-closed" src="<?php echo BASE_URL ?>/layout/template/img/logo.png" alt="Graindashboard" style="width: auto; height: 33px;">
            </a>
                    ...
                    <span class="unfold-item-icon mr-3">
                      <i class="gd-user"></i>
                        ...
                        <li class="unfold-item unfold-item-has-divider">
                            <a class="unfold-link d-flex align-items-center text-nowrap" href="<?php echo BASE_URL ?>/login/logout">
                    <span class="unfold-item-icon mr-3">
